...
const BASE_INSTRUCTIONS_ZH: &str = include_str!("../prompt_zh.md");
...
pub struct ModelFamily {
    ...
    /// Locale-specific variant of instructions, if available (e.g., zh-CN).
    pub base_instructions_zh: Option<String>,
}
...
pub fn find_family_for_model(slug: &str) -> Option<ModelFamily> {
    if slug.starts_with("o3") {
        ...
        model_family!(
            ...
            needs_special_apply_patch_instructions: true,
            base_instructions_zh: Some(GPT_5_CODEX_INSTRUCTIONS_ZH.to_string()),
        )
        ...
        model_family!(
            ...
            base_instructions_zh: Some(GPT_5_1_CODEX_MAX_INSTRUCTIONS_ZH.to_string()),
        ...
        || slug.starts_with("gpt-5.1-codex")
    {
        ...
        model_family!(
            ...
            base_instructions_zh: Some(GPT_5_1_INSTRUCTIONS_ZH.to_string()),
            apply_patch_tool_type: Some(ApplyPatchToolType::Freeform),
        )
