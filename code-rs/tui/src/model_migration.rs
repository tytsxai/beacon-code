...
pub(crate) fn migration_copy_for_key(key: &str) -> ModelMigrationCopy {
    match key {
        code_common::model_presets::HIDE_GPT5_1_MIGRATION_PROMPT_CONFIG => ModelMigrationCopy {
            ...
            content: &[
                "We've upgraded Beacon Code to gpt-5.1, gpt-5.1-code, and gpt-5.1-code-mini.",
        ...
        _ => ModelMigrationCopy {
            heading: "Beacon Code just got an upgrade: meet gpt-5.1-code-max",
            content: &[
                ...
                "Learn more: www.openai.com/index/gpt-5-1-code-max",
