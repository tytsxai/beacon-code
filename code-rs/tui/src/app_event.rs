...
pub(crate) enum AppEvent {
    ...
    AutoCoordinatorCheckpointSaved {
        session_id: String,
        turns: usize,
    },
    AutoCoordinatorCheckpointRestored {
        session_id: String,
        turns: usize,
    },
    AutoCoordinatorDiagnosticAlert {
        alert_type: String,
        message: String,
    },
    AutoCoordinatorBudgetAlert {
        alert_type: String,
        message: String,
    },
    AutoCoordinatorInterventionRequired {
        reason: String,
    },
