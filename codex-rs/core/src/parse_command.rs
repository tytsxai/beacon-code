...
/// The easiest way to iterate is to add unit tests and have Beacon Code fix the implementation.
...
/// Tests are at the top to encourage using TDD + Beacon Code to fix the implementation.
mod tests {
    use super::*;
    use std::path::PathBuf;
