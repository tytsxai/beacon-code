...
pub enum UpdateAction {
    /// Update via `npm install -g @tytsxai/beacon-code@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @tytsxai/beacon-code@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@tytsxai/beacon-code"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@tytsxai/beacon-code"]),
